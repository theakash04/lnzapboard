            ...
            <div className="max-w-lg w-full">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm sm:text-base text-gray-400 leading-relaxed max-w-md mx-auto">
                        Your support motivates me to keep building cool, open, freedom-focused
                        technology. Together, we can make peer-to-peer the default.
                    </p>
                </div>
                ...
                <div className="card-style p-6 sm:p-8">
                    ...
                    <div className="border-t border-border-purple pt-6 mb-6">
                        ...
                        {copiedNpub && (
                            <div className="text-center text-xs text-violet-300 mt-2">Copied!</div>
                        )}
                    </div>
                    ...
                    <div className="border-t border-border-purple pt-6">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div className="text-center">
                                ...
                                <div className="text-yellow-text font-bold text-xs mb-1">
                                    No Censorship
                                </div>
