        ...
        return (
            <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
                <div className="card-style p-6 max-w-md w-full">
                    <h2 className="text-yellow-text/90 font-bold text-xl mb-4">
                        Premium Board Payment
                    </h2>
                    <p className="text-white text-sm mb-4">
                        Pay{" "}
                        <span className="text-yellow-text/90 font-bold">{PREMIUM_AMOUNT} sats</span>{" "}
                                        ...
                                        <div className="mb-3 p-3 ">
                                            ...
                                            <ul className="text-gray-400 text-xs md:text-base space-y-1">
                                                <li className="flex items-start gap-2">
                                                    <span className="text-yellow-text/90 shrink-0">
                                                        •
                                                    </span>
